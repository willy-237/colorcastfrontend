...
import post from "../../assets/instagram post capture d'écran.png"
        ...
        <>
            ...
            <article className="article">
                ...
                <p data-aos="fade-down" data-aos-duration="1000">
                    « DNK » le nom du prochain album d’Aya Nakamura qui sortira le 7 avril Le 7 avril sortira le prochain album d’Aya Nakamura nommé DNK, la hype des fans est bien présente et le fait comprendre à l’artiste!
                </p>
                <p data-aos="fade-down" data-aos-duration="1000">
                    Sur son compte Instagram, Aya Nakamura a annoncé deux bonnes nouvelles pour ses fans : la sortie d’un nouvel album intitulé « DNK » le avril prochain, et un concert à l’Accor Arena à Paris le 26 mai prochain. Après « Journal intime » (2017), « Nakamura » (2018) et Aya (2020), le quatrième album « DNK », verra l’artiste collaborer avec Kim, Tiakola et SDM. Les précommandes sont déjà disponibles. C’est lors d’un live avec ses abonnés que la star a annoncé cette bonne nouvelle : « Je fais ce live pour annoncer à la populace que je vais sortir mon nouvel album, qui s’appelle DNK, pour Danioko qui est mon nom de famille ». Elle a conclu ces annonces par un prometteur « Ça va barder ». Et comme une bonne nouvelle n’arrive jamais seule, Aya Nakamura a aussi annoncé une date de concert à l’Accor Arena de Paris le 26 mai prochain. De quoi réjouir ses nombreux fans qui attendaient avec impatience de la retrouver sur scène. Aya Nakamura a annoncé son retour sur les réseaux sociaux.
                </p>
                <figure>
                    <img src={cover} alt="aya nakamura en fond" />
                </figure>
                ...
                <figure>
                    <img src={post} alt="post concernant aya nakamura" />
                </figure>
            </article>
            <Footer />
        </>
